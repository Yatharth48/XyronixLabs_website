...
import { Line, LineChart, Area, AreaChart, Bar, BarChart, XAxis, YAxis, CartesianGrid, Legend, ResponsiveContainer } from "recharts"
              ...
              <Tabs defaultValue="market" onValueChange={setActiveTab}>
                ...
                <TabsContent value="market" className="pt-6 min-h-screen">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 mt-4 text-center">
                    Global robotics market size in billions USD (2025-2027 projected)
                  </p>
                </TabsContent>
